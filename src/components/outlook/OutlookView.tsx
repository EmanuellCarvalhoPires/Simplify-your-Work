...
export const OutlookView: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleFailLoad = (e: any) => {
      ...
      setIsInitialLoad(false);
      setHasError(true);
      setErrorMessage(e.errorDescription || 'Falha ao conectar aos servidores do Microsoft Outlook.');
    };
  ...
  const handleOpenExternal = () => {
    if (window.electronAPI?.openExternal) {
      window.electronAPI.openExternal(OUTLOOK_URL);
    } else {
      window.open(OUTLOOK_URL, '_blank');
    }
  };
    ...
    <div style={styles.container}>
      ...
      <div style={styles.toolbar}>
        <div style={styles.navGroup}>
          ...
          <button onClick={handleReload} style={styles.toolButton} title="Recarregar Outlook">
            <RotateCcw size={16} className={isLoading ? 'spin-icon' : ''} />
          </button>
          <button onClick={() => handleNavigate(OUTLOOK_URL)} style={styles.toolButton} title="Página Inicial do Outlook">
            <Home size={16} />
          </button>
        </div>
        ...
        <div style={styles.shortcutsGroup}>
          <button
            onClick={() => handleNavigate('https://outlook.office.com/mail/')}
            style={styles.pillButton}
            title="Ir para Caixa de Entrada (Email)"
          >
            <Mail size={14} color="#0284c7" />
            <span>Email</span>
          </button>
          <button
            onClick={() => handleNavigate('https://outlook.office.com/calendar/')}
            style={styles.pillButton}
        ...
        <div style={styles.rightGroup}>
          ...
          <button
            ...
            title="Abrir Microsoft Outlook no navegador externo"
          >
      ...
      <div style={styles.webviewWrapper}>
        ...
        {isLoading && (
          <div style={styles.progressBarContainer}>
            <div className="outlook-loading-bar-inner" />
          </div>
        )}
        ...
        {isInitialLoad && !hasError && (
          <div style={styles.initialLoadingOverlay}>
            <div style={styles.initialLoadingCard}>
              ...
              <span style={styles.initialLoadingText}>Carregando Microsoft Outlook...</span>
            </div>
          </div>
        )}
        ...
        {hasError ? (
          <div style={styles.errorContainer}>
            <div style={styles.errorCard}>
              ...
              <h3 style={styles.errorTitle}>Não foi possível carregar o Outlook</h3>
